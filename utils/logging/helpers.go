...
import (
	datautil "github.com/universonic/cmdb/utils/data"
	zap "go.uber.org/zap"
...
func (in *FactoryConfig) Apply(level zapcore.Level, jsoned bool, highPriority ...zapcore.Level) (*LoggerFactory, error) {
	...
	if len(in.OutPath) == 1 && datautil.CheckIfStringMatchRegExp(in.OutPath[0], "stdout|stderr") &&
		len(in.ErrPath) == 1 && datautil.CheckIfStringMatchRegExp(in.ErrPath[0], "stdout|stderr") {
